...
Fig. 2 illustrates the chaotic behaviour of the system in time for each species.
...
Fig. 3 shows the divergence of trajectories caused by a small change in initial
...
Fig. 4 illustrates the appearance of chaotic behaviour as a function of changes in
