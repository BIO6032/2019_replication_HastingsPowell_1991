...
We were able to reproduce all the figures in their paper using *Julia v1.1.0*.
...
Hastings & Powell, and are in the same range of $z\_{max}$. We identified most of the local
maxima of $z$ found in the original paper for $b_1$ ranging from 2.2 to 6.2. However, we
missed some of them and we found others that were absent in their paper.
